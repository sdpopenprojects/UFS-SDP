% function [feaSubsets,res_gs,res_aio, res_gs_ps] = fs_unsup_glspfs_single_func(dataset, exp_settings, ~)
% function [feaSubsets,res_gs,res_aio, res_gs_ps] = fs_unsup_glspfs_single_func(X, Y, exp_settings, ~)
function [feaSubsets] = fs_unsup_glspfs_single_func(X, exp_settings, ~)
